...
const MainHeading = () => (
  ...
  <div className="flex flex-col gap-6 ml-5">
    <h2 className="leading-tight">
      <span className="block text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
    ...
    <p
      className="max-w-xl text-text4 text-gray-600 sm:text-lg lg:absolute lg:mt-[30px] lg:text-text2 lg:ml-[35rem]
